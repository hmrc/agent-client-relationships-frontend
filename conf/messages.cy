...
HMRC-CBC-ORG=Adrodd gwlad wrth wlad
HMRC-CBC-NONUK-ORG=Adrodd gwlad wrth wlad
HMRC-MTD-VAT=TAW
...
agentRoleFor.PERSONAL-INCOME-RECORD=asiant
agentRoleFor.HMRC-MTD-VAT=asiant
agentRoleFor.HMRC-TERS-ORG=asiant
agentRoleFor.HMRC-TERSNT-ORG=asiant
agentRoleFor.HMRC-CGT-PD=asiant
agentRoleFor.HMRC-PPT-ORG=asiant
...
definitiveAgentRoleFor.PERSONAL-INCOME-RECORD=yr asiant
definitiveAgentRoleFor.HMRC-MTD-VAT=yr asiant
definitiveAgentRoleFor.HMRC-TERS-ORG=yr asiant
definitiveAgentRoleFor.HMRC-TERSNT-ORG=yr asiant
definitiveAgentRoleFor.HMRC-CGT-PD=yr asiant
definitiveAgentRoleFor.HMRC-PPT-ORG=yr asiant
...
# -------------------------------------------------------------------------------------------
# Agent journey client service refinement
# -------------------------------------------------------------------------------------------
...
clientFact.HMRC-MTD-IT-SUPP.postcode.error.required=Nodwch god post eich cleient
...
confirmClient.true=Iawn - dyma’r cleient cywir
confirmClient.false=Na - mae angen i mi ddechrau eto

# ________________________________________________________________________________
# Agent journey select agent role
# ________________________________________________________________________________

selectAgentRole.HMRC-MTD-IT.newRelationship.header=Sut ydych am weithredu ar gyfer {0}?
selectAgentRole.HMRC-MTD-IT-SUPP.newRelationship.header=Sut ydych am weithredu ar gyfer {0}?
selectAgentRole.HMRC-MTD-IT.newRelationship.legend=Sut ydych am weithredu ar gyfer {0}?
selectAgentRole.HMRC-MTD-IT-SUPP.newRelationship.legend=Sut ydych am weithredu ar gyfer {0}?
selectAgentRole.HMRC-MTD-IT.guidance=<a href="{0}" class="govuk-link" target="_blank" rel="noreferrer noopener">Dysgwch sut y gall prif asiantau ac asiantau ategol weithredu ar eich rhan (yn agor tab newydd)</a>.
selectAgentRole.HMRC-MTD-IT-SUPP.guidance=<a href="{0}" class="govuk-link" target="_blank" rel="noreferrer noopener">Dysgwch sut y gall prif asiantau ac asiantau ategol weithredu ar eich rhan (yn agor tab newydd)</a>.
...
selectAgentRole.HMRC-MTD-IT.newRelationship.hint=Gall prif asiantau cyflawni’r holl swyddogaethau treth ar gyfer y cleient hwn a chyflwyno Ffurflenni Treth y cleient
selectAgentRole.HMRC-MTD-IT-SUPP.newRelationship.hint=Gall asiantau ategol cyflawni rhai swyddogaethau treth ar gyfer y cleient hwn, ond ni allant gyflwyno Ffurflenni Treth y cleient
...
selectAgentRole.HMRC-MTD-IT.mainToSupporting.guidance=<a href="{0}" class="govuk-link" target="_blank" rel="noreferrer noopener">Dysgwch sut y gall prif asiantau ac asiantau ategol weithredu ar eich rhan (yn agor tab newydd)</a>.
...
selectAgentRole.HMRC-MTD-IT.supportingToMain.guidance=<a href="{0}" class="govuk-link" target="_blank" rel="noreferrer noopener">Dysgwch sut y gall prif asiantau ac asiantau ategol weithredu ar eich rhan (yn agor tab newydd)</a>.
...
confirmCancellation.current-status=Ar hyn o bryd rydych wedi’ch awdurdodi fel {0} i reoli {1} {2}.
...
confirmCancellation.HMRC-MTD-IT-SUPP.outcome=Os byddwch yn canslo’ch awdurdodiad, ni fyddwch yn gallu rheoli cyfrif Troi Treth yn Ddigidol ar gyfer Treth Incwm ar gyfer {0}.
...
# ________________________________________________________________________________
# Confirmation of invitation complete
# ________________________________________________________________________________
...
# ________________________________________________________________________________
# Confirmation of agent cancel authorisation complete
# ________________________________________________________________________________
...
notAuthorised.HMRC-MTD-IT-SUPP.p=Nid yw’r cleient wedi’ch awdurdodi i reoli ei gynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm.
...
authorisationAlreadyExists.HMRC-MTD-IT-SUPP.p1=Mae’r cleient hwn eisoes wedi’ch awdurdodi i reoli ei gynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm.
...
authoriseAgentStartPage.h1.income-tax=Awdurdodi {0} i reoli’ch Troi Treth yn Ddigidol ar gyfer Treth Incwm
...
authoriseAgentStartPage.h2.income-tax=Defnyddiwch y manylion cywir ar gyfer mewngofnodi
authoriseAgentStartPage.p1.income-tax=Bydd angen i chi fewngofnodi gyda’r Dynodydd Defnyddiwr (ID) rydych chi’n ei ddefnyddio ar gyfer Troi Treth yn Ddigidol ar gyfer Treth Incwm
authoriseAgentStartPage.p2.income-tax=Os nad oes gennych Ddynodydd Defnyddiwr (ID) ar gyfer Troi Treth yn Ddigidol ar gyfer Treth Incwm, gallwch wneud y naill neu’r llall o’r canlynol:
authoriseAgentStartPage.li1.income-tax=mewngofnodi gyda’r ID Defnyddiwr rydych chi’n ei ddefnyddio ar gyfer eich cyfrif treth personol, neu
authoriseAgentStartPage.li2.income-tax=creu ID Defnyddiwr ar gyfer eich Cyfrif Treth Personol
...
consentInformation.header=Hoffai {0} bod eich {1}

consentInformation.warning.mainAgent=Os ydych yn awdurdodi {0}, byddwn yn tynnu {1} fel eich prif asiant presennol.
consentInformation.warning.agent=Os ydych yn awdurdodi {0}, byddwn yn tynnu {1} fel eich asiant presennol.
consentInformation.warning.suppAgent=Os ydych yn awdurdodi {0} fel eich asiant ategol, ni allant weithredu fel prif asiant mwyach.

consentInformation.section1.h2=Yn hyn sydd angen i chi wybod yn gyntaf
consentInformation.section1.p1=Gall asiant naill ai fod yn “prif asiant” neu “asiant ategol” pan fyddant yn rheoli’ch {0}.
...
confirmDecline.p2.link=Dysgwch sut y gall prif asiantau ac asiantau ategol weithredu ar eich rhan
...
checkYourAnswer.question=A ydych am i {0} fod eich {1} ar gyfer {2}?

checkYourAnswer.true=Iawn
checkYourAnswer.false=Na
checkYourAnswer.h2=Datganiad
checkYourAnswer.declarationYes.p1=Rwy’n deall sut y bydd {0} yn gallu gweithredu ar fy rhan. Rwy’n cadarnhau y gall CThEF ganiatáu i {0} weithredu fel fy {1} ar gyfer {2}.
checkYourAnswer.declarationNo.p1=Mae gwrthod y cais hwn gan {0} yn golygu na fyddant yn gallu gweithredu fel eich {1} ar gyfer {2}.
...
clientConfirmation.accepted.p1=Erbyn hyn, {0} yw’ch {1} ar gyfer {2}.
clientConfirmation.p2=Byddwn yn anfon e-bost at {0} i’w diweddaru.
...
clientConfirmation.rejected.p1=Nid ydych wedi rhoi caniatâd i {0} reoli’ch {2}.
clientConfirmation.PERSONAL-INCOME-RECORD.rejected.p1=Nid ydych wedi rhoi caniatâd i {0} fwrw golwg dros eich cofnod incwm personol.
...
manageYourTaxAgents.agentRole.HMRC-MTD-IT=Prif
manageYourTaxAgents.agentRole.HMRC-MTD-IT-SUPP=Ategol
...
manageYourTaxAgents.authorisedAgents.action.link=Tynnu awdurdodiad<span class=govuk-visually-hidden> o {0} i reoli’ch {1} fel {2}</span>
...
cannot-find-authorisation-request.header=Nid oes unrhyw geisiadau yn gysylltiedig â’r manylion mewngofnodi y gwnaethoch eu defnyddio
authorisation-request-expired.header=Mae’r cais hwn am awdurdodiad wedi dod i ben
authorisation-request-cancelled.header=Mae’r cais hwn am awdurdodiad wedi cael ei ganslo
agent-suspended.header=Ni allwch benodi’r asiant treth hwn
already-accepted-authorisation-request.header=Rydych eisoes wedi derbyn y cais hwn am awdurdodiad
already-refused-authorisation-request.header=Rydych eisoes wedi gwrthod y cais hwn am awdurdodiad
no-outstanding-requests.header=Nid oes unrhyw geisiadau am awdurdodiad dros ben i chi ymateb iddynt

# ________________________________________________________________________________
# You cannot appoint this tax agent (Agent suspended)
# ________________________________________________________________________________

agentSuspended.p1=Nid yw’r asiant treth hwn yn gallu {0} ar hyn o bryd.
...
noOutstandingRequests.p1=Os ydych o’r farn bod hyn yn anghywir, cysylltwch â’r asiant a anfonodd y cais atoch neu ewch ati i <a href="{0}" class="govuk-link">fwrw golwg dros hanes eich ceisiadau</a>.
...
authorisationRequestExpired.p2=Os hoffech i’r asiant hwn reoli’ch {0}, gofynnwch iddo anfon cais arall atoch am awdurdodiad.
...
cannotFindAuthRequest.p1=Mae’n bosibl eich bod wedi defnyddio’r dynodydd defnyddiwr (ID) anghywir i fewngofnodi.
cannotFindAuthRequest.p2=Mae angen i chi ddefnyddio’r manylion mewngofnodi sy’n cyd-fynd â’r gwasanaeth treth y mae’r asiant am ei reoli ar eich rhan.
cannotFindAuthRequest.p3=Er enghraifft, os yw asiant eisiau rheoli eich TAW, dylech wneud y canlynol:
cannotFindAuthRequest.bullet1=sicrhau eich bod chi wedi cofrestru ar gyfer TAW, a bod gennych gyfrif TAW ar-lein
cannotFindAuthRequest.bullet2=defnyddio eich manylion mewngofnodi TAW wrth ymateb i gais am awdurdodiad
cannotFindAuthRequest.signIn=Mewngofnodi gyda dynodydd defnyddiwr (ID) gwahanol
cannotFindAuthRequest.signOut=Gorffen ac allgofnodi
...
# ________________________________________________________________________________
# You already refused this authorisation request
# ________________________________________________________________________________

authorisationAlreadyRefused.p1=Gwrthodwyd y cais hwn ar {0}.
authorisationAlreadyRefused.p2=Os hoffech i’r asiant hwn reoli’ch {0}, gofynnwch iddo anfon cais arall atoch am awdurdodiad.
authorisationAlreadyRefused.mytaLink=Rheoli’ch asiantau treth
authorisationAlreadyRefused.signOutLink=Gorffen ac allgofnodi
