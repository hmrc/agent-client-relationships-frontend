...
package uk.gov.hmrc.agentclientrelationshipsfrontend.views.utils

import play.api.data.{Field, Form}
import play.api.i18n.Messages
import uk.gov.hmrc.agentclientrelationshipsfrontend.views.components.RadioData
...
object ViewUtils {
  ...
  def dateErrorMapping(field: String, form: Form[?]): Map[String, String] =
