...
import uk.gov.hmrc.agentclientrelationshipsfrontend.config.FeatureFlags
import uk.gov.hmrc.agentmtdidentifiers.model.Service

/** The set of services available that an agent can choose for authorisation
  *
  */
case class InvitationsBasket(clientType: ClientType, services: Set[Service], basket: Set[AuthorisationRequest], featureFlags: FeatureFlags) {
