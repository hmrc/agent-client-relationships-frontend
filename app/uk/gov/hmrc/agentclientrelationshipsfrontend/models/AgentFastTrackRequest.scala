...
object AgentFastTrackRequest {
  implicit val clientIdFormat: Format[TaxIdentifier] = TaxIdFormat.taxIdFormat
  implicit val format: OFormat[AgentFastTrackRequest] = Json.format[AgentFastTrackRequest]
}
