...
enum JourneyType:
  case CreateInvitation, CreateInvitationFastTrack, LedDeauthInvitation

implicit val journeyTypeReads: Reads[JourneyType] = Reads[JourneyType] { json =>
  json.validate[String].flatMap {
    case "CreateInvitation"   => JsSuccess(JourneyType.CreateInvitation)
    case "CreateInvitationFastTrack" => JsSuccess(JourneyType.CreateInvitationFastTrack)
    case "LedDeauthInvitation" => JsSuccess(JourneyType.LedDeauthInvitation)
