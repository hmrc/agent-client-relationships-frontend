...
object DoYouAlreadyManageForm extends FormFieldHelper {
  def form(clientName: String): Form[Boolean] = Form(
    single(
      DoYouAlreadyManageFieldName -> optional(boolean)
        .verifying(mandatoryBoolean("doYouAlreadyManage", clientName))
