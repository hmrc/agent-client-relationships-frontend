...
import uk.gov.hmrc.agentclientrelationshipsfrontend.models.KnownFactResult._
import uk.gov.hmrc.agentclientrelationshipsfrontend.util.UriPathEncoding.encodePathSegment
import uk.gov.hmrc.agentmtdidentifiers.model._
import uk.gov.hmrc.domain.{Nino, SimpleObjectReads, TaxIdentifier}
import uk.gov.hmrc.http.HttpReads.Implicits._
import uk.gov.hmrc.http.{HttpClient, _}
import uk.gov.hmrc.play.bootstrap.metrics.Metrics
import uk.gov.hmrc.agentclientrelationshipsfrontend.util._
...
@Singleton
class AgentClientAuthorisationConnector @Inject()(http: HttpClient, val metrics: Metrics, appConfig: AppConfig)(implicit val ec: ExecutionContext)
