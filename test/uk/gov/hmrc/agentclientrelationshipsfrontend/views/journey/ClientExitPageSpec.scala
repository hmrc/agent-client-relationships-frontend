...
class ClientExitPageSpec extends ViewSpecSupport {
  ...
  object Expected {
    ...
    val authorisationRequestExpiredParagraphOne = "This request expired on 11.11.2024. For details, view your history to check for any expired, cancelled or outstanding requests."
    ...
    val authorisationRequestCancelledParagraphOne = "This request was cancelled by your agent on 11.11.2024. For details, view your history to check for any expired, cancelled or outstanding requests."
    ...
    val alreadyRespondedToAuthorisationRequestParagraphOne = s"This request has already been responded to on 11.11.2024. For details, view your history to check for any expired, cancelled or outstanding requests."
