...
import uk.gov.hmrc.agentclientrelationshipsfrontend.models.journey.{ClientJourney, ClientJourneyRequest, AgentJourneyType}
...
class CheckYourAnswerPageSpec extends ViewSpecSupport {
  ...
  val journey: ClientJourney = ClientJourney(
    journeyType = AgentJourneyType.ClientResponse
  )
