...
import uk.gov.hmrc.agentclientrelationshipsfrontend.models.ClientType.{Business, Personal}
import uk.gov.hmrc.agentclientrelationshipsfrontend.models.KnownFactResult._
import uk.gov.hmrc.agentclientrelationshipsfrontend.support.{BaseISpec, TestDataCommonSupport}
